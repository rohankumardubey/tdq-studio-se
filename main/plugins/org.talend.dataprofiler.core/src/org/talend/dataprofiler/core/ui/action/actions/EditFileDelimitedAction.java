...
public class EditFileDelimitedAction extends Action {
    ...
    @Override
    public void run() {
        RepositoryWorkUnit<Object> repositoryWorkUnit = new RepositoryWorkUnit<Object>("Edit File connection", this) {

            @Override
            protected void run() throws LoginException, PersistenceException {
                if (node != null) {
                    Wizard wizard =
                            new DelimitedFileWizard(PlatformUI.getWorkbench(), false, (RepositoryNode) node, null);
