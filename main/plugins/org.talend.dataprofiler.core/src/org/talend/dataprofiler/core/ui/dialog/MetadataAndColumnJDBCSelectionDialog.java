...
public class MetadataAndColumnJDBCSelectionDialog extends ColumnsSelectWithJDBCConstraintDialog {
     ...
     * @param parent
     */
    public MetadataAndColumnJDBCSelectionDialog(Shell parent, String title, List<IRepositoryNode> checkedRepoNodes,
            String message) {
    ...
    public MetadataAndColumnJDBCSelectionDialog(Shell parent, String title, DataManager dataManager, String message) {
