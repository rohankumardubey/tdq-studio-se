...
public class RepNodeUtilsTest {
    ...
    //
    // /**
    // * can not use the real project to test, because the method RepositoryNodeHelper.getDataProfilingFolderNode will
    // use
    ...
    // stub(method(RepositoryNodeHelper.class, "getReportRepNodes", IRepositoryNode.class, boolean.class,
    ...
    // * {@link
    // org.talend.dataprofiler.core.ui.utils.RepNodeUtils#updateJrxmlRelatedReport(org.eclipse.core.runtime.IPath,
    ...
    //
    // /**
    // * Test: 2) when the selected nodes are: multiple table/views, multiple columns from different table/view, will
    // not
    // * be valid;
    // */
    // @Test
