...
public class ColumnSetIndicatorEvaluatorTest {
    ...
    public void testExecuteSqlQuery_file() throws Exception {
        ...
        // stub(method(DelimitedFileIndicatorEvaluator.class, "addResultToIndicatorToRowMap", Indicator.class,
        // EMap.class)); //$NON-NLS-1$
        ...
        // when(StringUtils.loadConvert(realFieldSeparator,
        // ECodeLanguage.JAVA.getName())).thenReturn(realFieldSeparator);
